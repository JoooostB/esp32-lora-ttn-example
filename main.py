...
NETWORK_SESSION_KEY = bytearray([0xA4, 0x69, 0x94, 0x45, 0xCA, 
                            0x7C, 0x12, 0x0A, 0x07, 0x8C, 0xE7, 0x7B, 0xB9, 0x23, 0x0E, 0x61])
APP_SESSION_KEY = bytearray([0x0B, 0x54, 0xC8, 0x3B, 0x78, 0x41,
                             0xE8, 0xAF, 0x96, 0x66, 0x3C, 0x9E, 0xC4, 0x12, 0x45, 0x39])
